...
const { fetchUrl, isUrl, processTime } = require("./lib/𝐤𝐢𝐧𝐚𝐫𝐚func");
const { TelegraPh, UploadFileUgu, webp2mp4File, floNime } = require('./lib/dreadupload');
const { Configuration, OpenAIApi } = require("openai");
let setting = process.env.AI; 
const { smsg, formatp, tanggal, formatDate, getTime,  sleep, clockString, fetchJson, getBuffer, jsonformat, format, parseMention, getRandom } = require('./lib/𝐤𝐢𝐧𝐚𝐫𝐚func');
const { exec, spawn, execSync } = require("child_process");
module.exports = 𝐤𝐢𝐧𝐚𝐫𝐚 = async (client, m, chatUpdate, store) => {
  try {
    var body =
...
const botname = process.env.BOTNAME || '𝐆𝐎𝐋𝐃𝐅𝐈𝐒𝐇-𝐀𝐈';
...
const menu = process.env.MENU_TYPE || 'VIDEO';
 const DevDreaded = dev.split(",");
   ...
   const bad = process.env.BAD_WORD || 'fuck';
    ...
    const Owner = Dev𝐊𝐢𝐧𝐚𝐫𝐚.map((v) => v.replace(/[^0-9]/g, "") + "@s.whatsapp.net").includes(m.sender)
    // Group
...
const admin = process.env.ADMIN_MSG || '𝐇𝐮𝐡!\n𝐀𝐝𝐦𝐢𝐦𝐬 𝐨𝐧𝐥𝐲, 𝐃𝐮𝐦𝐦𝐲.';
    ...
    const NotOwner = process.env.NOT_OWNER_MSG || '𝐆𝐎𝐋𝐃𝐅𝐈𝐒𝐇 𝐨𝐧𝐥𝐲 ☬';
...
"《 ██████████▒▒》80%",
"《 ████████████》100%",
"	✦𝐋𝐨𝐚𝐝𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𝐆𝐎𝐋𝐃𝐅𝐈𝐒𝐇! ☫"
]
let { key } = await client.sendMessage(from, {text: '𝐋𝐨𝐚𝐝𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥 𝐛𝐲 𝐆𝐎𝐋𝐃𝐅𝐈𝐒𝐇! ☬...'})
...
if (antilink === 'TRUE' && antilinkall === 'TRUE' && body.includes('http') && !Owner && isBotAdmin && !isAdmin && m.isGroup) { 
 ...
 client.sendMessage(m.chat, {text:`Auf wiedersehen:\n\n@${ki.split("@")[0]}, sending links is prohibited in this group!`, contextInfo:{mentionedJid:[ki]}}, {quoted:m}); 
    ...
    if (cmd && !m.isGroup) {
      console.log(chalk.black(chalk.bgWhite("[ 𝐆𝐨𝐥𝐝𝐟𝐢𝐬𝐡-𝐚𝐢 ]")), color(argsLog, "turquoise"), chalk.magenta("From"), chalk.green(pushname), chalk.yellow(`[ ${m.sender.replace("@s.whatsapp.net", "")} ]`));
...
if (menu === 'VIDEO') {
                   ...
                   client.sendMessage(m.chat, {
                        video: fs.readFileSync('./𝐆𝐎𝐋𝐃𝐅𝐈𝐒𝐇.mp4'),
                        caption: cap,
			sourceUrl: "https://whatsapp.com/channel/0029Vb16LZ14tRrucAIa471m",   
                        gifPlayback: true
                    }, {
                        quoted: m
                    })
...
client.sendMessage(m.chat, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnail: fs.readFileSync('./𝐊𝐢𝐧𝐚𝐫𝐚-𝐌𝐚𝐫𝐤.jpg'),
                                sourceUrl: 'https://whatsapp.com/dl/254113634286?text=ʜᴇʟʟᴏ+𝐈𝐭𝐬_𝐒𝐢𝐫𝐦™𝕏+Nihostie+Bot+Mkuu+🥲',
                                mediaType: 1,
...
await m.reply('𝐑𝐞𝐦𝐨𝐯𝐞𝐝 𝐬𝐮𝐜𝐜𝐞𝐬𝐬𝐟𝐮𝐥𝐥𝐲 𝐛𝐲 𝙂𝙤𝙡𝙙𝙛𝙞𝙨𝙝☬'); 
} catch (errr) { 
...
`👋🏻 Hi *${pushname}*,You can deploy 𝐆𝐎𝐋𝐃𝐅𝐈𝐒𝐇-𝐀𝐈 using the GitHub link below🌌\n\nFork and give us a star✨.\n\nhttps://github.com/kinara-ops/GOLDFISH-AI/edit/main/dreaded.js\n\nEnjoy and have fun with the bot🔥...\n\nUse the link below to pair 𝐆𝐨𝐥𝐝𝐟𝐢𝐬𝐡-𝐀𝐢 without scanning any qr code\n\n [https://replit.com/@pesguru02/Pairing-𝐆𝐨𝐥𝐝𝐟𝐢𝐬𝐡-Ai]\n\nMade on Earth by 𝙆𝙞𝙣𝙖𝙧𝙖 𝙈𝙖𝙧𝙠 });
...
case "ping": case "speed": { 
 ...
 case "runtime": { 
                 m.reply (`𝐆𝐎𝐋𝐃𝐅𝐈𝐒𝐇-𝐀𝐈 𝙷𝚊𝚜 𝙱𝚎𝚎𝚗 𝙰𝚌𝚝𝚒𝚟𝚎 𝙵𝚘𝚛 ${runtime(process.uptime())}`) 
 } 
 break;
...
const audiovn = "./alive.mp3";
    const dooc = {
        ...
        contextInfo: {
          ...
          externalAdReply: {
          title: "𝐇𝐢 𝐇𝐮𝐦𝐚𝐧,𝐆𝐨𝐥𝐝𝐟𝐢𝐬𝐡 𝐁𝐨𝐭 𝐈𝐬 𝐀𝐥𝐢𝐯𝐞 𝐚𝐧𝐝 𝐊𝐢𝐜𝐤𝐢𝐧𝐠",
          body: "https://whatsapp.com/channel/0029Vb16LZ14tRrucAIa471m",
          thumbnailUrl: "https://telegram.org/dl",
          sourceUrl: "https://whatsapp.com/dl/",
          mediaType: 1,
          renderLargerThumbnail: true
          }}
      };
...
break;
 ...
 break 
   ...
   client.sendMessage(m.chat, { image: buffer, caption: `*𝐂𝐨𝐧𝐯𝐞𝐫𝐭𝐞𝐝 𝐛𝐲 Goldfish ☬*`}, { quoted: m }) 
...
case "movie": 
 ...
 break;
    ...
    break;
         ...
         for (let i of res) { 
             let txt = `*_</ 𝐆𝐎𝐋𝐃𝐅𝐈𝐒𝐇 𝐁𝐎𝐓𝐁𝐑𝐎𝐀𝐃𝐂𝐀𝐒𝐓 >\n\n🀄 Message: ${text}\n\nAuthor: ${pushname}_*` 
 ...
 break;
          ...
          case 'join': { 
                 ...
                 let result = args[0].split('https://whatsapp.com/dl/')[1] 
